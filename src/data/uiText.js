export const uiTextByLanguage = {
  en: {
    ...
    allProducts: {
      title: 'PDF Tools',
      desc: 'Convert, compress, sign, and transform PDF files.',
      ...
      searchAriaLabel: 'Search PDF tools',
      searchEmpty: 'No matching PDF tools.',
      searchClearLabel: 'Clear search',
    },
    worldwide: {
  ...
  zh: {
    nav: {
      ...
      freeAiToolsMega: {
        ...
        links: {
          ...
          jpgToPdf: 'JPG 转 PDF',
          xmlToPdf: 'XML 转 PDF',
          wordToJpg: 'Word 转 JPG',
          jpgToWord: 'JPG 转 Word',
        },
        newBadge: '新',
      },
    },
    ...
    allProducts: {
      title: 'PDF Tools',
      desc: '转换、压缩、签署和处理 PDF 文件。',
      catalogBadge: '产品目录',
      viewByCategory: '分类',
      viewAZ: 'A–Z',
      tabsAriaLabel: '产品分类',
      viewModeAriaLabel: '目录视图',
      searchPlaceholder: '搜索 PDF 工具...',
      searchAriaLabel: '搜索 PDF 工具',
      searchEmpty: '没有匹配的 PDF 工具。',
      searchClearLabel: '清除搜索',
    },
    worldwide: {
      badge: '全球语言地图',
